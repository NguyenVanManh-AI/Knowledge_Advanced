                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="w-5"><i class="fa-solid fa-signature"></i> ID</th>
                                <th scope="col"><i class="fa-solid fa-signature"></i> Folder Name</th>
                        ...
                        <tbody id="table_body_folder">
                            <tr v-for="(record, index) in records" :key="index">
                                <th class="table-cell" scope="row">#{{ (big_search.page - 1) * big_search.per_page + index +
                                    1 }}</th>
                                <td class="table-cell displaytext break text-center">{{ truncatedTitle(record.id) }}</td>
...
export default {
    ...
    setup() {
        document.title = "Manage Folder | Knowledge"
    },
    data() {
        return {
            course_id: null,
